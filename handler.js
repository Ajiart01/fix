...
export async function handler(chatUpdate) {
    ...
    global.img = 'https://telegra.ph/file/0c4be183c36003a4e0bdb.jpg' 
    ...
    switch (action) {
        ...
        case 'remove':
            if (chat.welcome) {
                ...
                let welc = 'WELCOME'
                    let outss = 'GOOD BYE'
                    let pp = 'https://telegra.ph/file/0c4be183c36003a4e0bdb.jpg'
                    try {
...
let wel = API('dham', '/api/canvas/welcome3', {
...
let res = "Sudah Dini Hari Kok Belum Tidur Kak? sini ku bantu tidurin🤗"
if (time >= 4) {
	res = "Pagi Lord 🌄"
}
if (time >= 10) {
