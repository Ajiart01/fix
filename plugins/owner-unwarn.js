let handler = async (m, { conn, args }) => {
    ...
    conn.reply(mention, '*Kamu telah di Unwarning OWNER Atau MODERATOR, sekarang kamu memiliki *' + (global.db.data.users[mention].warn * 1) + '* warning', wm, [['Owner', usedPrefix + 'owner']], null)
}
